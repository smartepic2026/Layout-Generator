...
> **갱신 (D-032, 2026-06-06)**: 아래 (A) 항목 **전부 소비 완료**. zones·ACPH·
> 천정고·갱의·airlock flow_type·door_count·corridor_width·equipment_clearance 반영.
> (B) 항목은 3D/HVAC·로그로 2D 평면도 비대상 → 의도적 미반영 유지.

**(A) 의미 있는 누락/왜곡 — ✅ D-032 에서 전부 반영**
